			...
			<div className="category-container">
				...
				<div className="inline-scroll">
					{store.people.map( (item, index) => {
						return(
							<div key={item._id} className="card" style={{width: "18rem", display: "inline-block", marginRight: "15px"}}>
								...
								<div className="card-body">
									...
									<div className="d-flex justify-content-between">
										<button className="btn custom-learn-button" onClick={() => switchView(item["_id"])}>Learn more</button>
										<button className="btn custom-heart-button" onClick={() => actions.addFavorite(store, item._id, item.properties.name)}> 
